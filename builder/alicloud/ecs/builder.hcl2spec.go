...
type FlatConfig struct {
	...
	ECSImagesDiskMappings             []FlatAlicloudDiskDevice `mapstructure:"image_disk_mappings" mapstructure-to-hcl2:"image_disk_mapping" required:"false" cty:"image_disk_mapping"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"image_disk_mapping":           &hcldec.BlockListSpec{TypeName: "image_disk_mapping", Nested: hcldec.ObjectSpec((*FlatAlicloudDiskDevice)(nil).HCL2Spec())},
