...
type Plugin interface {
	...
	//
	// Configure is responsible for translating this configuration into an
	// internal structure, validating it, and returning any errors. Hopefully
	// Packer defines some helpers to help you get this sorted out depending on
	// the underlying type received.
	//
	//  * a []map[string]interface{} will be passed when using a single build
	//    file.
	...
	// human friendly errors that can be returned directly from the prepare
	// method.
	//
